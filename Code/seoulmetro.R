...
write.csv(station.info,file="../Data/seoulmetro/master_station_info.csv", row.names=FALSE)
write.csv(station.distance,file="../Data/seoulmetro/master_station_distance.csv", row.names=FALSE)
